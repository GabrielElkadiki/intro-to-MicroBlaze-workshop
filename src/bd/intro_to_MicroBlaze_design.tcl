...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set func_sel [ create_bd_port -dir I func_sel ]
  set led [ create_bd_port -dir O -from 15 -to 0 led ]
  set reset [ create_bd_port -dir I -type rst reset ]
  set_property -dict [ list \
CONFIG.POLARITY {ACTIVE_LOW} \
 ] $reset
  set reset_shift_flash [ create_bd_port -dir I reset_shift_flash ]
  set shift_sel [ create_bd_port -dir I shift_sel ]
...
CONFIG.MMCM_COMPENSATION.VALUE_SRC {DEFAULT} \
  ...
  # Create instance: flash_shift_ip_0, and set properties
  set flash_shift_ip_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:flash_shift_ip:1.0 flash_shift_ip_0 ]
...
CONFIG.USE_BOARD_FLOW {true} \
  ...
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M01_AXI [get_bd_intf_pins flash_shift_ip_0/S00_AXI] [get_bd_intf_pins microblaze_0_axi_periph/M01_AXI]
  ...
  connect_bd_net -net clk_wiz_0_clk_out3 [get_bd_pins PmodOLEDrgb_0/ext_spi_clk] [get_bd_pins clk_wiz_0/clk_out3]
  connect_bd_net -net clk_wiz_0_locked [get_bd_pins clk_wiz_0/locked] [get_bd_pins rst_clk_wiz_1_100M/dcm_locked]
  connect_bd_net -net flash_shift_ip_0_led [get_bd_ports led] [get_bd_pins flash_shift_ip_0/led]
  connect_bd_net -net func_sel_1 [get_bd_ports func_sel] [get_bd_pins flash_shift_ip_0/func_sel]
  connect_bd_net -net mdm_1_debug_sys_rst [get_bd_pins mdm_1/Debug_SYS_Rst] [get_bd_pins rst_clk_wiz_1_100M/mb_debug_sys_rst]
  connect_bd_net -net microblaze_0_Clk [get_bd_pins PmodOLEDrgb_0/s_axi_aclk] [get_bd_pins PmodOLEDrgb_0/s_axi_aclk2] [get_bd_pins axi_mem_intercon/ACLK] [get_bd_pins axi_mem_intercon/S00_ACLK] [get_bd_pins axi_mem_intercon/S01_ACLK] [get_bd_pins axi_uartlite_0/s_axi_aclk] [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins flash_shift_ip_0/clk] [get_bd_pins flash_shift_ip_0/s00_axi_aclk] [get_bd_pins microblaze_0/Clk] [get_bd_pins microblaze_0_axi_periph/ACLK] [get_bd_pins microblaze_0_axi_periph/M00_ACLK] [get_bd_pins microblaze_0_axi_periph/M01_ACLK] [get_bd_pins microblaze_0_axi_periph/M02_ACLK] [get_bd_pins microblaze_0_axi_periph/M03_ACLK] [get_bd_pins microblaze_0_axi_periph/S00_ACLK] [get_bd_pins microblaze_0_local_memory/LMB_Clk] [get_bd_pins rst_clk_wiz_1_100M/slowest_sync_clk]
  ...
  connect_bd_net -net reset_shift_flash_1 [get_bd_ports reset_shift_flash] [get_bd_pins flash_shift_ip_0/reset]
  ...
  connect_bd_net -net rst_clk_wiz_1_100M_peripheral_aresetn [get_bd_pins PmodOLEDrgb_0/s_axi_aresetn] [get_bd_pins axi_mem_intercon/S00_ARESETN] [get_bd_pins axi_mem_intercon/S01_ARESETN] [get_bd_pins axi_uartlite_0/s_axi_aresetn] [get_bd_pins flash_shift_ip_0/s00_axi_aresetn] [get_bd_pins microblaze_0_axi_periph/M00_ARESETN] [get_bd_pins microblaze_0_axi_periph/M01_ARESETN] [get_bd_pins microblaze_0_axi_periph/M02_ARESETN] [get_bd_pins microblaze_0_axi_periph/M03_ARESETN] [get_bd_pins microblaze_0_axi_periph/S00_ARESETN] [get_bd_pins rst_clk_wiz_1_100M/peripheral_aresetn]
  ...
  connect_bd_net -net shift_sel_1 [get_bd_ports shift_sel] [get_bd_pins flash_shift_ip_0/shift_sel]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x44A00000 [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs flash_shift_ip_0/S00_AXI/S00_AXI_reg] SEG_flash_shift_ip_0_S00_AXI_reg
